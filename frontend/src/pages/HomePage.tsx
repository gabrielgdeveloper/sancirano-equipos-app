    ...
    <div className="flex flex-col gap-8">
      ...
      {standings.length > 0 && (
        <section>
          ...
          <StandingsTable standings={standings} compact zones={getTournamentBySlug(slug ?? "")?.zones} showPromotion={slug === "primera"} showPlayoff={slug === "intermedia" || (slug?.startsWith("pre-intermedia") ?? false)} showGanador={false} ganadorLimit={slug === "m15-a" ? 4 : 6} />
        </section>
      )}
    </div>
  );
