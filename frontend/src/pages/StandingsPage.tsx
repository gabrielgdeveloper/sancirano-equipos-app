...
export function StandingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {standings.length > 0 ? (
        <StandingsTable standings={standings} compact={false} zones={tournamentConfig?.zones} showPromotion={slug === "primera"} showPlayoff={slug === "intermedia" || (slug?.startsWith("pre-intermedia") ?? false)} showGanador={false} ganadorLimit={slug === "m15-a" ? 4 : 6} />
      ) : (
